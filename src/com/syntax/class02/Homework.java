...
byte box1=127;
		...
		char gender='m';
		char dollar='$'; //single quotations for single character
		...
		System.out.println("sleepy"); //sleepy //quotes make it a text
		
		//System.out.println(box5); //error because of order
		int box5=900; //top to bottom and left to right
